...
#### 4️⃣ Rozwiąż duplikaty (tylko tryb DODAJ)

**Jeśli wybrano DODAJ i są duplikaty:**
```
┌───────────────────────────────────────────────┐
...
│                                              │
│ ┌──────────────────────────────────────────┐│
│ │Imię │ Obecny       │ Importowany         ││
│ ├──────────────────────────────────────────┤│
│ │Jan K│ 10.01.2024   │ 20.01.2024         ││
│ │     │ Ocen: 15     │ Ocen: 22           ││
│ │     │ ● Zachowaj   │ ○ Zastąp           ││
│ └──────────────────────────────────────────┘│
│                                              │
│ [Anuluj] [Zastosuj i kontynuuj]            │
└───────────────────────────────────────────────┘
```

**Wybierz dla każdego:**
- ● **Zachowaj obecnego** - obecny zostaje, importowany odrzucany
- ● **Zastąp importowanym** - obecny nadpisywany, importowany wchodzi

📖 **Więcej:** [WYKRYWANIE_DUPLIKATOW.md](WYKRYWANIE_DUPLIKATOW.md)
